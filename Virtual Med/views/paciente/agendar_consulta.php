        ...
        <div class="form-container">
            <form action="index.php?action=salvar_consulta" method="POST">
                    ...
                    <div class="consultation-card">
                        ...
                        <div class="card-content">
                            <div class="form-group">
                                <select id="doutor_id" name="doutor_id" required>
                                    <option value="">Escolha um médico</option>
                                    <?php foreach ($doutores as $doutor): ?>
                                        <option value="<?= $doutor['id'] ?>">
                                            Dr(a). <?= htmlspecialchars($doutor['nome']) ?> - <?= htmlspecialchars($doutor['especialidade']) ?>
                                        </option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                ...
                <div class="action-buttons">
                    ...
                    <a href="index.php?action=painel_paciente" class="cancel-button">Cancelar</a>
                </div>
            </form>
        </div>
    </div>
