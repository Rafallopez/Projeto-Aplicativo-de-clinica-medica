        ...
        <div class="form-container">
            <form action="index.php?action=atualizar_perfil" method="POST">
                    ...
                    <div class="consultation-card">
                        ...
                        <div class="card-content">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" value="<?= date('d/m/Y', strtotime($paciente['data_nascimento'])) ?>" readonly>
                            </div>
                            <div class="form-group">
                                <label>Plano de Saúde:</label>
                                <input type="text" value="<?= htmlspecialchars($paciente['plano_saude']) ?>" readonly>
                            </div>
                        </div>
                    </div>
                ...
                <div class="action-buttons">
                    ...
                    <a href="index.php?action=painel_paciente" class="cancel-button">Voltar ao Painel</a>
                </div>
            </form>
        </div>
    </div>
